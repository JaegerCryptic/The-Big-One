...
public class AddNewClass extends javax.swing.JDialog {

    ManageClassService manageClassService = new ManageClassImpl();

    public AddNewClass(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public AddNewClass(java.awt.Frame parent) {
        super(parent);
        initComponents();
    }
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if (classDescription.getText().trim().length() == 0) {
            JOptionPane.showMessageDialog(this, "Please enter Class Description!");
            return;
        }

        
        int newId = manageClassService.addClass(classTopic.getText().trim(), classDescription.getText().trim());
        
        if (newId>0) {
            JOptionPane.showMessageDialog(this, "Class details are saved! \n New Class ID = "+ String.valueOf(newId), "Class Details", JOptionPane.INFORMATION_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(this, "Error while saving the class details!", "Class Details", JOptionPane.ERROR);            
        }
    }//GEN-LAST:event_saveActionPerformed

    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed

this.classTopic.setText("");
